...
**/
@Configuration
@MapperScan(basePackages = "com.stcock.rabbitclient.dao.mapper", sqlSessionFactoryRef = "sqlSessionFactoryDB")
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryDB(
            ...
            @Value("classpath:com/stcock/rabbitclient/dao/mapper/**/*.xml") Resource[] resources
    ) throws Exception {
